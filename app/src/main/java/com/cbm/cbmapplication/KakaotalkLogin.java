...
public class KakaotalkLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_custom_login = (Button) findViewById(R.id.loginBtn);
                ...
                UserManagement.getInstance()
                        .requestLogout(new LogoutResponseCallback() {
                            ...
                            public void onCompleteLogout() {
                                Toast.makeText(KakaotalkLogin.this, "로그아웃 되었습니다.", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });*/
            ...
            UserManagement.getInstance()
                    .me(new MeV2ResponseCallback() {
                        ...
                        public void onSuccess(MeV2Response result) {
                            ...
                            String url = result.getProfileImagePath(); // 프로필사진이 이값이에요
