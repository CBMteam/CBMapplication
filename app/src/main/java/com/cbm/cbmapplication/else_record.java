...
public class else_record extends AppCompatActivity {
        ...
        btnend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               if(choice.equals("인슐린")){
                   ...
                   else_record.FeatureTask ftask=new else_record.FeatureTask(else_record.this);
                   ftask.execute(URL+"/insulin/add",user_email,value,date);
               }
               else if(choice.equals("식사량")){
                   else_record.ElseTask task=new else_record.ElseTask(else_record.this);
                   task.execute("http://"+IP_ADDRESS+"/carbinsert.php",user_email,value,date);
                   else_record.FeatureTask ftask=new else_record.FeatureTask(else_record.this);
                   ftask.execute(URL+"/carb/add",user_email,value,date);
               }
    ...
    public class FeatureTask extends AsyncTask<String, Void, String> {

        private static final String TAG = "FeatureTask";

        public Context mContext;

        public FeatureTask(Context mContext) {
            super();
        ...
        protected String doInBackground(String... params) {
            ...
            // TODO : 위에 추가한 형식처럼 아래 postParameters에 key과 value를 계속 추가시키면 끝이다.
            // ex : String postParameters = "name=" + name + "&country=" + country;
            String postParameters = "email=" + user_email + "&value=" + user_value + "&fDate=" + user_date;
