...
public class Calendar extends AppCompatActivity {
    ...
    static private ListView callist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCarbTask carbtask=new getCarbTask(Calendar.this);
        carbtask.execute("http://"+IP_ADDRESS+"/getcarb.php",user_email,date);

        getInsulinTask insulintask=new getInsulinTask(Calendar.this);
        insulintask.execute("http://"+IP_ADDRESS+"/getinsulin.php",user_email,date);
...
//                버튼 클릭시 동작
    ...
    public class getCarbTask extends AsyncTask<String, Void, String> {

        private static final String TAG = "getCarbTask";

        public Context mContext;

        public getCarbTask(Context mContext) {
            super();
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null) {
                ...
                showResultCarb(result); //JSON 형태의 결과를 처리
            }
        }
    ...
    public class getInsulinTask extends AsyncTask<String, Void, String> {

        private static final String TAG = "getInsulinTask";

        public Context mContext;

        public getInsulinTask(Context mContext) {
            super();
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null) {
                ...
                showResultInsulin(result); //JSON 형태의 결과를 처리
            }
        }
...
//        }
    ...
    private void showResultCarb(String mJsonString) {

        String TAG_JSON = "carb_list"; //어레이 이름
        /*php 파일에서 넘긴 json 이름들*/
        String TAG_DATETIME = "fDate";
        String TAG_CARB = "carb";
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                adapter.addItem("식사량 " + result_carb, result_datetime);
    ...
    private void showResultInsulin(String mJsonString) {

        String TAG_JSON = "insulin_list"; //어레이 이름
        /*php 파일에서 넘긴 json 이름들*/
        String TAG_DATETIME = "fDate";
        String TAG_INSULIN = "insulin";
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                adapter.addItem("인슐린 " + result_insulin,result_datetime);
